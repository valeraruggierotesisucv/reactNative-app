const en = {
    ...
    event_published: "Your event has been published successfully",
    event_edited: "Your event has been edited successfully",
...
const es = {
    ...
    event_edited: "Tu evento se ha editado con éxito",
